let apiKey = 'apiKey=02f5fb5b27fd467cb014b23a2d18c566';
let ShowFirstNews=5;
let urlNow ='';
let CountNews = 5;
...
let controller = {
    ...
    init: function(){
        ...
        document.getElementById('header__searth-btn').onclick = function(){
        ...
        document.getElementById('header__searth-text').addEventListener('keyup', function(e){
            if (e.keyCode === 13){        
